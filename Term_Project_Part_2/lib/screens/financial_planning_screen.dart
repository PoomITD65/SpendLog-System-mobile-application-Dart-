...
import 'package:teamproject_3/screens/financial_overview_screen.dart'; // นำเข้าไฟล์ FinancialOverviewScreen
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            ); // นำทางไปที่หน้า FinancialOverviewScreen
          },
        ),
      ),
      body: Stack(
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      double progress = (_goals[index]['savings'] ?? 0.0) /
                          _goals[index]['amount'];
